...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/76 shadow-[0_18px_70px_rgba(2,6,23,0.24)] backdrop-blur-2xl">
      ...
      <Container className="flex h-[4.5rem] items-center justify-between gap-3">
        ...
        <nav
          className="hidden items-center gap-1 rounded-full border border-white/10 bg-white/[0.045] p-1 shadow-[0_18px_60px_rgba(2,6,23,0.28)] backdrop-blur-xl xl:flex"
