...
export function QuickStartTimeline() {
  return (
    <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.045] p-5 shadow-glow backdrop-blur-xl sm:p-7">
      ...
      <div className="space-y-4">
        {quickStartSteps.map((step, index) => (
          <div key={step.title} className="grid gap-4 rounded-3xl border border-white/10 bg-slate-950/35 p-5 sm:grid-cols-[auto_1fr]">
